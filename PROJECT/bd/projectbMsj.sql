...
CREATE TABLE `mensajes` (
  ...
  `mensajes` varchar(500) DEFAULT NULL,
  `codUsuario` int NOT NULL,
  PRIMARY KEY (`idMensajes`),
  KEY `codUsuario_msj_idx` (`codUsuario`),
  CONSTRAINT `codUsuario_msj` FOREIGN KEY (`codUsuario`) REFERENCES `usuario` (`codUsuario`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mensajes` VALUES (1,'felixcriollovigo@gmail.com','asunto-error','lorem ipsum',4),(2,'felixcriollovigo@gmail.com','asunto importante','llorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum orem ipsum lorem ipsum lorem ipsum lorem ipsum ',4),(3,'genaro010204@gmail.com ','prueba','lorem ipsum',4),(4,'psJimmy@MesaServico.net','pedro pica piedra','¿por que pedro pica piedra?',2);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `usp_listarMensajeUsuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_listarMensajeUsuario`()
select u.nombreUsuario, m.idMensajes, m.correo, m.asunto, m.mensajes
	from mensajes as m
    inner join usuario as u
    where u.codUsuario = m.codUsuario ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
-- Dump completed on 2022-06-09 13:40:42
